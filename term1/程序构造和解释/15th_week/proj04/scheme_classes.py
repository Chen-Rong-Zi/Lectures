...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        if symbol in self.bindings:
            ...
            return type(self).lookup(self.parent, symbol)
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        child = Frame(self)
        formals_backup = formals
        vals_backup = vals
        while formals_backup is not nil:
            child.define(formals_backup.first, vals_backup.first)
            formals_backup = formals_backup.rest
            vals_backup = vals_backup.rest
        return child
        "*** YOUR CODE HERE ***"
        # END PROBLEM 8
