...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # <++>
        lambda_func = do_lambda_form(Pair(formals, args), env)
        env.define(signature.first, lambda_func)
...
def do_mu_form(expressions, env):
    ...
    validate_formals(formals)
    # BEGIN PROBLEM 11
#     print(MuProcedure(formals, expressions.rest))
